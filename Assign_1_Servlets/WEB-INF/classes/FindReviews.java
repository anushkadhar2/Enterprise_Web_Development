...
public class FindReviews extends HttpServlet {
				...
				for(int x = 0; x <extraSettings.length; x++){
					switch (extraSettings[x]){						
						...
						case "GROUP_BY":	
							...
							}else if(groupByDropdown.equals("GROUP_BY_REVIEWRATING")){
	...
	public void constructGroupByLikedCityWise(AggregationOutput aggregate, PrintWriter output, boolean countOnly){
		int rowCount = 0;
		int productCount = 0;
		String tableData = " ";
		String pageContent = " ";
