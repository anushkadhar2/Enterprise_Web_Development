...
public class TakeTwoInteractive extends HttpServlet {
	            ...
	            out.println("<title>Take Two Interactive Products</title>");
				...
				out.println(" <header>");
				out.println(" <h1>Take Two Interactive Product</h1>");
				...
				out.println("</ul>");
				out.println("</nav>");
				out.println("<img class='header-image' src='images/img_takeTwoInteractive.jpg' width = '100%' height = '100%' alt='xbox' />");
				out.println("<div id='body'>");
				out.println("<section id='content'>");
				out.println("<article>");
				out.println("<h2>Take Two Interactive Products</h2>");
