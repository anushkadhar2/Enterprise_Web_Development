...
public class Activision extends HttpServlet {
	            ...
	            out.println("<title>Activision Products</title>");
				...
				out.println(" <header>");
				out.println(" <h1>Activison Product</h1>");
				out.println(" <h2>Buy Latest Products</h2>");
				out.println(" </header>");
				...
				out.println("</ul>");
				out.println("</nav>");
				out.println("<img class='header-image' src='images/img_activision.jpg' width = '100%' height = '100%' alt='xbox' />");
				out.println("<div id='body'>");
				out.println("<section id='content'>");
				out.println("<article>");
				out.println("<h2>Activision Products</h2>");
				...
				String searchParameter = "Activision";
