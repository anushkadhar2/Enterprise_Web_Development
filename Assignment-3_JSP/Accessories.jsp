<html>
	...
	<body>
			...
			<header>
			<h1> ACCESSORIES </h1>
			<h2>Welcome To ACCESSORIES  PAGE</h2>
			</header>
			...
			<img class="header-image" src="images/img_accessories.jpg" width = "100%" height = "100%" alt="accessories" />
			<div id="body">
			<section id="content">
			<article>
			<h2>Accessories</h2>
			<h1>Types Of Accessories Products</h1>
