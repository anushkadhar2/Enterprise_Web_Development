<html>
	<head>
		...
		<title>MICROSOFT GAME PRODUCTS</title>
	...
	<body>
			...
			<header>
			<h1>Microsoft</h1>
			<h2>Welcome To MICROSOFT GAME PRODUCTS</h2>
			</header>
			...
			<img class="header-image" src="images/img_XBox.jpg" width = "100%" height = "100%" alt="xbox" />
			<div id="body">
			<section id="content">
			<article>
			<h2>Microsoft</h2>
			<h1>Types Of Microsoft Products</h1>
			...
			String searchParameter = "Microsoft";
			...
			while(cursor.hasNext()){
				...
				<td><input type="text" name="productPrice" value=<%=obj.getString("productPrice")%> readonly></td>
				</tr>
				
				<tr>
				<td>
				<h4>Product Discount: </h4></td>
				<td><input type="text" name="productDiscount" value=<%=obj.getString("productDiscount")%> readonly></td>
				</tr>
				
				<tr>
				<td><h4>Product Price: </h4></td>
				<td><input type="text" name="productManufacturerRebate" value=<%=obj.getString("productManufacturerRebate")%> readonly></td>
				</tr>
				
				<tr>
				<td><h4>Product Type:</h4></td>
				<td><input type="text" name="productType" value= <%=obj.getString("productType")%> readonly></td>
				</tr>
					
			
				<form class = "submit-button" method = "post" action = "writeReviews.jsp">
