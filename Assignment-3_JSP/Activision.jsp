<html>
	<head>
		...
		<title>Activision GAME PRODUCTS</title>
		<link rel="stylesheet" href="webPage.css" type="text/css" />
	</head>
	<body>
			<div id="container">
			<header>
			<h1>ACTIVISION PRODUCTS</h1>
			<h2>Welcome To Activision GAME PRODUCTS</h2>
			</header>
			...
			<img class="header-image" src="images/img_activision.jpg" width = "100%" height = "100%" alt="xbox" />
			<div id="body">
			<section id="content">
			<article>
			<h2>Activision</h2>
			<h1>Types Of Activision Products</h1>
