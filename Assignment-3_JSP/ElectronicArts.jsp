<html>
	<head>
		...
		<title>Electronic Arts GAME PRODUCTS</title>
	...
	<body>
			...
			<h2>Welcome To Electronic Arts GAME PRODUCTS</h2>
			</header>
			...
			<img class="header-image" src="images/img_electronicArts.jpg" width = "100%" height = "100%" alt="xbox" />
			<div id="body">
			<section id="content">
			<article>
			<h2>Electronic Arts</h2>
			<h1>Types Of Electronic Arts Products</h1>
