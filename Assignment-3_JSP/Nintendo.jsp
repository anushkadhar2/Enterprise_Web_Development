<html>
	<head>
		...
		<title>NINTENDO GAME PRODUCTS</title>
		<link rel="stylesheet" href="webPage.css" type="text/css" />
	</head>
	<body>
			<div id="container">
			<header>
			<h1>Nintendo Products</h1>
			<h2>Welcome To NINTENDO GAME PRODUCTS</h2>
			</header>
			...
			<img class="header-image" src="images/img_wii.jpg" width = "100%" height = "100%" alt="xbox" />
			<div id="body">
			<section id="content">
			<article>
			<h2>NINTENDO</h2>
			<h1>Types Of Nintendo Products</h1>
			...
			String searchParameter = "Nintendo";
