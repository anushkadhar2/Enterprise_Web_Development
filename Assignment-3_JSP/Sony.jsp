<html>
	<head>
		...
		<title>SONY GAME PRODUCTS</title>
	...
	<body>
			...
			<header>
			<h1>Sony Page</h1>
			<h2>Welcome To SONY GAME PRODUCTS</h2>
			</header>
			...
			<img class="header-image" src="images/img_PlayStation.jpg" width = "100%" height = "100%" alt="xbox" />
			<div id="body">
			<section id="content">
			<article>
			<h2>SONY</h2>
			<h1>Types Of PlayStation Products</h1>
