...
public class ElectronicArts extends HttpServlet {
	            ...
	            out.println("<title>Electronic Arts Products</title>");
				...
				out.println(" <header>");
				out.println(" <h1>Electronic Arts Products</h1>");
				out.println(" <h2>Buy Latest Games</h2>");
				out.println(" </header>");
				...
				out.println("</ul>");
				out.println("</nav>");
				out.println("<img class='header-image' src='images/img_electronicArts.jpg' width = '100%' height = '100%' alt='xbox' />");
				out.println("<div id='body'>");
				out.println("<section id='content'>");
				out.println("<article>");
				out.println("<h2>Electronic Arts Products</h2>");
				out.println("<h1>Types Of Product</h1>");
				...
				String searchParameter = "ElectronicArts";
